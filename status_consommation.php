...
<div class="tab">
  <button class="tablinks" onclick="openPage(event, 'Sommaire 12m')">Sommaire12m</button>
  <button class="tablinks" onclick="openPage(event, 'Sommaire 60j')" id="defaultOpen">Sommaire60j</button>
...
echo "<table id=\"customers2\"><tr><th>Année</th><th>Mois</th><th>Nb sessions</th><th>Energie (kWh)</th><th>Cout ($)</th><th>Durée (mn)</th></tr>";
...
echo "<table id=\"customers2\"><tr><th>Année</th><th>Mois / Jour</th><th>Nb sessions</th><th>Energie (kWh)</th><th>Couts ($)</th><th>Durée (mn)</th></tr>";
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
